...
const PaymentScreen = () => {
    return (
        <ImageBackground source={require("../assets/paymentbg.png")} className="h-full w-full items-center ">
            ...
            <View className="h-[550px] w-full bg-white absolute bottom-0 rounded-t-[35px] items-center">
                <Image source={require('../assets/mastercard.png')} className="w-[334px] h-[195px] rounded-[30px] -m-28" />
                ...
                <View className="mt-32 items-center space-y-4">
                    ...
                    <TouchableOpacity className="w-[360px] h-[77px] bg-[#FF0000] rounded-[40px] justify-center items-center">
