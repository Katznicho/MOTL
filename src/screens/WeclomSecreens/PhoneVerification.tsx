...
const PhoneVerification = ({ }) => {
    ...
    return (
        <View className=" items-center flex-1 relative" >
            ...
            <View className="m-5 absolute top-0 left-0">
                <ArrowLeftIcon className="m-5 mt-9" color="black" size={30} onPress={() => navigation.goBack()} />
            </View>
            ...
            <View >
                <View className="mt-[100px] items-center">
                    ...
                    <View className="border-2 bg-[#D9D9D9] px-5 w-72 h-30 rounded-[8px] items-center mt-5 flex-row border-[#7d7d7d]">
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('EnterPinScreen')}
                        className="bg-[#FF0000] w-72 h-14 rounded-[30px] items-center  justify-center mt-14 " >
